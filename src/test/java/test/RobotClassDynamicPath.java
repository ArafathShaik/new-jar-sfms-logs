...
public class RobotClassDynamicPath
{
    public Robot robot;
    
    public static void main(final String[] args) throws Exception {
        final RobotClassDynamicPath keyboard = new RobotClassDynamicPath();
    }
    
    public RobotClassDynamicPath() throws AWTException {
        this.robot = new Robot();
    }
    
    public RobotClassDynamicPath(final Robot robot) {
        this.robot = robot;
    }
    
    public void type(final CharSequence characters) throws InterruptedException {
        Thread.sleep(3000L);
