...
public class ERRequestCreationTestRobot
{
    Actions actions;
    String refnumber;
    WebDriver driver;
    ...
    public void createERRequest() throws MalformedURLException, AWTException, InterruptedException {
        ...
        this.driver.findElement(By.xpath("//input[@id='reconIFSC']")).sendKeys("IFDK0000001");
    ...
    @Test(priority = 4, description = "Logout Script")
    ...
    @Test(priority = 5, dependsOnMethods = { "createERRequest" }, description = "Verifying the Enhanced Reconciliation Request")
    public void verifyERRequest() throws InterruptedException, MalformedURLException, AWTException {
        Thread.sleep(5000L);
        this.driver.findElement(By.xpath("//input[@id='uaiUserId']")).sendKeys(PropertiesUtility.properties.getProperty("RequestAccorRej"));
        this.driver.findElement(By.xpath("//input[@id='uaiUserNodeAddrs']")).sendKeys(PropertiesUtility.properties.getProperty("ERIFSC"));
        System.out.println("Entered User id and IFSC Code Successfully");
        Thread.sleep(15000L);
        this.driver.findElement(By.id("token_signin")).click();
        ...
        this.actions = new Actions(this.driver);
        Thread.sleep(5000L);
        WebElement message = this.driver.findElement(By.xpath("//li[@class='active has-sub']/a/span[contains(text(),'Others')]"));
        this.actions.moveToElement(message).build().perform();
        this.actions.moveToElement(this.driver.findElement(By.cssSelector("#othersMenu > li:nth-child(7) > a:nth-child(2) > span:nth-child(1)"))).click().build().perform();
        this.actions.moveToElement(this.driver.findElement(By.xpath("//li[@class='active has-sub']/child::ul/li/a/span[contains(text(),'Reconciliation Request Action Listing')]"))).click().build().perform();
        Thread.sleep(12000L);
        ...
        this.robot.keyPress(10);
        this.robot.keyRelease(10);
        this.driver.findElement(By.xpath("//table[@id='enhcdRcnReqListingTableId']/tbody/tr/td[contains(text(),'" + this.refnumber + "')]")).click();
        Thread.sleep(4000L);
        final WebElement approvebuton = this.driver.findElement(By.xpath("//button[@class='ui-button ui-corner-all ui-widget' and contains(text(),'Approve')]"));
        ...
        Thread.sleep(5000L);
        Assert.assertEquals("Request approved Sucessfully", this.driver.findElement(By.id("statusMsg")).getText());
        this.driver.findElement(By.cssSelector("#toggleSuccess > span:nth-child(2) > button:nth-child(1)")).click();
        message = this.driver.findElement(By.xpath("//li[@class='active has-sub']/a/span[contains(text(),'Others')]"));
        this.actions.moveToElement(message).build().perform();
        this.actions.moveToElement(this.driver.findElement(By.cssSelector("#othersMenu > li:nth-child(7) > a:nth-child(2) > span:nth-child(1)"))).click().build().perform();
        this.actions.moveToElement(this.driver.findElement(By.xpath("//li[@class='active has-sub']/child::ul/li/a/span[contains(text(),'Reconciliation Request Listing')]"))).click().build().perform();
        if (this.driver.findElement(By.xpath("//table[@id='enhcdRcnReqListingTableId']/tbody/tr/td[contains(text(),'" + this.refnumber + "')]")).isDisplayed()) {
            System.out.println("Created Reference Number " + this.refnumber + " is displayed on the ER Request Listing Grid");
        }
        else {
            System.out.println("Created Reference Number " + this.refnumber + " is not displayed on the ER Request Listing Grid");
        }
    }
    
    @Test(priority = 6, description = "Logout Script")
    public void logOutApp1() throws MalformedURLException, InterruptedException {
        this.actions = new Actions(this.driver);
        final WebElement userProfile = this.driver.findElement(By.xpath("//div[@class='display_user']"));
        this.actions.moveToElement(userProfile).build().perform();
        Thread.sleep(4000L);
    ...
    @Test(priority = 7, description = "close the browser")
